...
\author{Lizhen Qu$^{1,2}$, Gabriela Ferraro$^{1,2}$, Liyuan Zhou$^1$, Weiwei Hou$^1$, \\
 \textbf{Nathan Schneider$^3$ \and Timothy Baldwin$^{1,4}$} \\[1ex]
$^1$ NICTA, Australia \\
$^2$ The Australian National University\\
$^3$ University of Edinburgh\\
$^4$ The University of Melbourne \\
{\smaller{\tt \{lizhen.qu,gabriela.ferraro,liyuan.zho,weiwei.hou\}@nicta.com.au}}\\
{\smaller{\tt nschneid@cs.cmu.edu}}\\
{\smaller{\tt tb@ldwin.net}}\\
~~\\
}
...
\begin{abstract} 
  ...
  part-of-speech tagging, syntactic chunking, named entity recognition, and  multiword expression identification.
