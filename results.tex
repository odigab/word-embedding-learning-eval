...
\begin{subfigure}{6cm}
	\centering
    \includegraphics[scale=0.3]{plots/map-pos}    	
	\label{fig:bestpos}
	\subcaption{POS-Tagging Accuracy}	
\end{subfigure}
\begin{subfigure}{6cm}
	\centering
    \includegraphics[scale=0.3]{plots/map-chunk}
...
\begin{subfigure}{6cm}
	\centering
    \includegraphics[scale=0.3]{plots/map-ner}    	
	\label{fig:bestpos}
	\subcaption{NER F1-Measure}	
\end{subfigure}
\begin{subfigure}{6cm}
	\centering
    \includegraphics[scale=0.3]{plots/map-mwe}
	\label{fig:bestchunking}
...
\begin{subfigure}{6cm}
	\centering
    	\includegraphics[scale=0.3]{plots/POS-OOV-IN}
    	\subcaption{\textit{in domain} }
	\label{fig:inpos}
\end{subfigure}
\begin{subfigure}{6cm}
	\centering
    	\includegraphics[scale=0.3]{plots/POS-OOV-OUT}
...
\begin{subfigure}{6cm}
	\centering
    	\includegraphics[scale=.3]{plots/NER-OOV-IN}
    	\subcaption{\textit{in-domain}}
	\label{fig:inner}
\end{subfigure}
\begin{subfigure}{6cm}
	\centering
    	\includegraphics[scale=0.3]{plots/NER-OOV-OUT}
   	\subcaption{\textit{out-of-domain}}
	\label{fig:outner}
\end{subfigure}  	
\end{figure*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% OOV Chunking and MWE
\begin{figure*}[h]
\caption{Chunking and MWE out-of-vocabulary-words accuracy for \textit{in-domain} test set}
\centering
\begin{subfigure}{6cm}
	\centering
    	\includegraphics[scale=.3]{plots/Chunking-OOV}
    	\subcaption{\textit{in-domain}}
	\label{fig:inner}
\end{subfigure}
\begin{subfigure}{6cm}
	\centering
    	\includegraphics[scale=0.3]{plots/MWE-OOV}
   	\subcaption{\textit{out-of-domain}}
	\label{fig:outner}
\end{subfigure}  	
\end{figure*}
...
%\centering
%    	\includegraphics[scale=.3]{plots/MWE-OOV}    
%\label{fig:outmwe}
%\end{figure}
