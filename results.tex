...
We also found that fine-tuning can correct poorly learned word representations, but can 
overfit the representations if the unsupervised ones are already good. 
