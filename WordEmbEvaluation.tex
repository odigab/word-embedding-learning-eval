...
\newcite{Bansal+:2014} used word embeddings as features for dependency parsing. To built the vectors, they used the syntactic dependency context instead of the linear context in raw text.
...
% Grammar induction (Spitkovsky at el., 2013)
