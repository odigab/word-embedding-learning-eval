...
\title{Instructions for IWPT 2015 Proceedings}
...
\begin{abstract}
  ...
  manuscript for the proceedings of IWPT~2015. The document itself
...
to IWPT 2015 or accepted for publication in its proceedings. All
...
\url{http://ixa2.si.ehu.es/iwpt2015/}. Please check this website 
regularly.
...
the official IWPT 2015 style file (\texttt{acl2015.sty}) and bibliography style
(\texttt{acl.bst}). These files are available at
\url{http://ixa2.si.ehu.es/iwpt2015/}. You will also find the document
you are currently reading (template.pdf) and its \LaTeX\ source code
(template.tex) on this website.

You can alternatively use LibreOffice or Microsoft Word to produce your
PDF file. In 
this case, we strongly recommend the use of the template file
(acl2015.dot) on the IWPT 2015 website.
...
a number of \LaTeX\ packages, including the IWPT 2015 style file. These
...
Long papers may consist of up to nine pages of content, plus any number
of extra
pages for references. Short papers may consist of up to four pages of
content.  Papers that do not
