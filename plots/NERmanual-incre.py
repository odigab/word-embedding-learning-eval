...
alist_filter = ['cbow_negsam_updated_best_manual.txt',  
...
for root, subdirs, files in os.walk(walk_dir):
	...
	for filename in natsorted(files):  		
		if filename in alist_filter: 
			if re.match("cbow_negsam_updated_best_manual.txt", filename): label = "cbow_negsam_up"
			...
			elif re.match("cw_updated_best.txt", filename): label = "cw_up"
...
#plt.title('Best results from all methods')
