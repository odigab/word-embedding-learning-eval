...
#		y = ['p[38]','p[113]','p[262]','p[561]','p[1159]','p[2354]','p[4745]','p[9527]','p[19091]','p[38219]'],
		y = ['[38]','[113]','[262]','[561]','[1159]','[2354]','[4745]','[9527]','[19091]','[38219]'],
#		y = [38 + empty, 113+empty, 262+empty,561+empty,1159+empty,2354+empty,4745+empty,9527+empty,19091+empty,38219+empty],
